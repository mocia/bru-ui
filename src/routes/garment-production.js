module.exports = [
  ...
  // {
  //     route: '/garment-production/laporan-stock-barang-jadi',
  //     name: 'production-stock-barang-jadi',
  //     moduleId: './modules/garment-production/laporan-stock-barang-jadi/index',
  //     nav: true,
